...
test('entregue: status, ganho, estrelas e card clicável', () => {
  ...
  fireEvent.click(screen.getByText(/Pedido #123456/));
  expect(onDetails).toHaveBeenCalled();
});

test('cancelada: mostra status Cancelado e sem estrelas', () => {
